...
const Button = React.forwardRef<HTMLButtonElement, Props>(
  (
    { className, mode = "default", size = "md", asChild = false, ...props },
    ref
  ) => {
    ...
    return (
      <Comp
        className={cn(
          "font-medium",
          className,
          "inline-flex items-center justify-center gap-2 rounded-md border text-sm transition-all cursor-pointer",
